...
public class Aritmeticos extends javax.swing.JInternalFrame {
    ...
    private void bVerificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar1ActionPerformed
        ...
        try{
            ...
            boolean resp =  aritmetico.Multiplos(num1, num2);
            if(resp){
                JOptionPane.showMessageDialog(this, "El numero "+ num1 + " es multiplo de "+ num2, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
            }else{
                 JOptionPane.showMessageDialog(this, "El numero "+ num1 + " no es multiplo de "+ num2, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        ...
        try{
            ...
            double numS1 = Double.parseDouble(tfNum3.getText());
            double numS2 = Double.parseDouble(tfNum4.getText());
            double numM1 = Double.parseDouble(tfNum5.getText());
            double numM2 = Double.parseDouble(tfNum6.getText());
            double numD = Double.parseDouble(tfNum7.getText());
            
           
            double total = aritmetico.CalcularResultadoExpresion1(numS1, numS2, numM1, numM2, numD);
           
            JOptionPane.showMessageDialog(this, "El resultado de la expresion anterior es: "+ total, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bCalcular3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular3ActionPerformed
        // TODO add your handling code here:
          try{
            ...
            double numS1 = Double.parseDouble(tfNum8.getText());
            double numS2 = Double.parseDouble(tfNum9.getText());
            double numM = Double.parseDouble(tfNum10.getText());
            double numD1= Double.parseDouble(tfNum11.getText());
            double numD2 = Double.parseDouble(tfNum12.getText());
            
           
            double total = aritmetico.CalcularResultadoExpresion2(numS1, numS2, numM, numD1, numD2);
    ...
    private void bCalcular4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular4ActionPerformed
        // TODO add your handling code here:
         try{
            ...
            double numBase = Double.parseDouble(tfNum13.getText());
            double numExponente = Double.parseDouble(tfNum14.getText());
            
            
           
            double resultado = aritmetico.CalcularResultadoExpresion3(numBase, numExponente);
           
            JOptionPane.showMessageDialog(this, "El resultado de la expresion anterior es: "+ resultado, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bCalcular5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular5ActionPerformed
        // TODO add your handling code here:
         try{
            ...
            double resultado = aritmetico.CalcularResultadoExpresion4(num1, num2, num3);
